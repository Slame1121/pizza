...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/questions')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_questions'),
					'href'     => $this->url->link('catalog/questions', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'catalog/actionData')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_action_data'),
					'href'     => $this->url->link('catalog/actionData', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			
			if ($this->user->hasPermission('access', 'catalog/actionPages')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_action_pages'),
