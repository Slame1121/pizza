...
class ControllerExtensionModuleUlogin extends Controller {
	...
	public function index() {
		...
		$data['text_module_description'] = sprintf($this->language->get('text_module_description'), $this->url->link('module/ulogin_sets', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		...
		if (!isset($this->request->get['module_id'])) {
			$data['breadcrumbs'][] = array(
				...
				'href' => $this->url->link('extension/module/ulogin', 'user_token=' . $this->session->data['user_token'], 'SSL')
			);
		} else {
			$data['breadcrumbs'][] = array(
				'text' => $this->language->get('heading_title'),
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('extension/module/ulogin', 'user_token=' . $this->session->data['user_token'], 'SSL');
		} else {
		...
		$this->response->setOutput($this->load->view('module/ulogin', $data));
	}
